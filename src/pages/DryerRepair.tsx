  ...
  const commonProblems = [
    {
      icon: AlertTriangle,
      title: 'Не включается',
      description: 'Сушильная машина не реагирует на нажатие кнопок, нет индикации',
      price: 'от 1800 ₽'
    },
    {
      icon: Wind,
      title: 'Не сушит белье',
      description: 'Машина работает, но белье остается влажным после цикла',
      price: 'от 2200 ₽'
    },
    {
      icon: Zap,
      title: 'Перегревается',
      description: 'Сушильная машина сильно нагревается, срабатывает защита',
      price: 'от 2800 ₽'
    },
    {
      icon: TrendingUp,
      title: 'Сильный шум',
      description: 'Машина издает громкие звуки при работе, стук или скрежет',
      price: 'от 2000 ₽'
    }
  ];
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            >
              <h1 className="text-4xl lg:text-5xl font-bold text-gray-900 mb-6">
                Ремонт сушильных машин <span className="text-red-600">Bosch</span> в Сочи
              </h1>
              <p className="text-xl text-gray-600 mb-8 leading-relaxed">
                Профессиональный ремонт сушильных машин Bosch на дому. 
            ...
            >
              <div className="bg-white p-8 rounded-2xl shadow-2xl">
                <img
                  src="https://images.pexels.com/photos/6197119/pexels-photo-6197119.jpeg?auto=compress&cs=tinysrgb&w=500"
                  alt="Ремонт сушильных машин Bosch"
                ...
                {activeTab === 'problems' && (
                  <div>
                    <h2 className="text-2xl font-bold text-gray-900 mb-8">
                      Частые неисправности сушильных машин Bosch
                    </h2>
            ...
            <ScrollAnimation delay={0.2}>
              <div className="bg-white p-8 rounded-2xl shadow-lg border-2 border-red-500">
                <div className="text-center">
                  ...
                  <div className="text-3xl font-bold text-gray-900 mb-2">от 2800 ₽</div>
                  <p className="text-gray-600 mb-6">включая работу</p>
                  <ul className="text-sm text-gray-600 space-y-2">
                    <li>✓ Замена фильтров</li>
                    <li>✓ Ремонт нагревателя</li>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <ScrollAnimation>
            <h2 className="text-3xl lg:text-4xl font-bold text-white mb-6">
              Сушильная машина Bosch сломалась?
            </h2>
